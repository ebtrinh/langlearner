	...
	const lesson1Content = {
		...
		steps: [
			...
			},
			{
				...
				correct: 0,
				correctExplanation: 'Perfect! "Hablo" (AH-bloh) is correct. For -ar verbs like hablar, we remove -ar and add -o.',
				...
				alternativeCorrectExplanation: 'Perfect! "Camino" (kah-MEE-noh) is correct. For -ar verbs like caminar, we remove -ar and add -o.',
			...
			},
			{
				...
				correct: 0,
				correctExplanation: 'Excellent! "Como" (KOH-moh) is correct. For -er verbs like comer, we remove -er and add -o.',
				...
				alternativeCorrect: 0,
				alternativeCorrectExplanation: 'Excellent! "Bebo" (BEH-boh) is correct. For -er verbs like beber, we remove -er and add -o.',
			...
			},
			{
				...
				correctAnswer: 'vivo',
				correctExplanation: 'Perfect! "Vivo" (VEE-voh) is correct.',
				...
				alternativeCorrectExplanation: 'Perfect! "Escribo" (es-KREE-boh) is correct.',
			...
			},
			{
				...
				correctAnswer: 'tengo',
				correctExplanation: 'Excellent! "Tengo" (TEN-goh) is correct. Tener is irregular in the yo form.',
				...
				alternativeCorrectExplanation: 'Excellent! "Quiero" (kee-EH-roh) is correct. Querer is a stem-changing verb where e becomes ie.',
			...
			},
			{
				...
				question: 'How do you say "I want water and coffee" in Spanish? (querer = to want [STEM-CHANGING: e → ie], agua = water, café = coffee)',
				correctAnswer: 'quiero agua y cafe',
				correctExplanation: 'Perfect! "Quiero agua y café" (kee-EH-roh AH-gwah ee kah-FEH) - you\'ve mastered using yo with querer and Y!',
				wrongExplanation: 'Remember: use the yo form of querer (quiero) + agua y café.',
				alternativeQuestion: 'How do you say "I want tea or coffee" in Spanish? (té = tea, o = or)',
				alternativeAnswer: 'quiero te o cafe',
				alternativeCorrectExplanation: 'Perfect! "Quiero café" (kee-EH-roh kah-FEH) - you\'ve mastered using yo with querer!',
			...
			},
			{
				...
				questionNumber: 6,
				inputType: 'application',
				question: 'How do you say "I have a book and a pen" in Spanish? (tener = to have [IRREGULAR: yo form has g], un libro = a book, una pluma = a pen)',
				correctAnswer: 'tengo un libro y una pluma',
				correctExplanation: 'Excellent! "Tengo un libro y una pluma" (TEN-goh oon LEE-broh ee OO-nah PLOO-mah) - you\'re really getting this!',
				wrongExplanation: 'Remember: use the yo form of tener (tengo) + un libro y una pluma.',
				alternativeQuestion: 'How do you say "I eat meat or fish" in Spanish? (como = I eat, carne = meat, pescado = fish)',
				alternativeAnswer: 'como carne o pescado',
				alternativeCorrectExplanation: 'Excellent! "Como comida" (KOH-moh koh-MEE-dah) - you\'re really getting this!',
