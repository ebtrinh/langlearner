	...
	const lesson2Content = {
		...
		steps: [
			...
			// Multiple Choice Questions (1-4)
			{
				...
				correct: 1,
				correctExplanation: 'Correct! "Hablas" (AH-blahs) means "you speak".',
			...
			},
			{
				...
				correct: 2,
				correctExplanation: 'Perfect! "Come" (KOH-meh) means "he/she eats".',
			...
			},
			{
				...
				correct: 2,
				correctExplanation: 'Excellent! "Vivimos" (vee-VEE-mohs) means "we live".',
			...
			},
			{
				...
				correct: 1,
				correctExplanation: 'Great! "Caminan" (kah-MEE-nahn) means "they walk".',
			...
			// Typed Questions (5-8)
			{
				...
				correctExplanation: 'Perfect! "Trabajas" (trah-BAH-hahs) means "you work".',
			...
			},
			{
				...
				correctExplanation: 'Excellent! "Corremos" (koh-RREH-mohs) means "we run".',
			...
			},
			{
				...
				correctAnswer: 'abre',
				correctExplanation: 'Great job! "Abre" (AH-breh) means "he/she opens".',
			...
			},
			{
				...
				correctExplanation: 'Perfect! "Deciden" (deh-SEE-dehn) means "they decide".',
			...
			// Application Questions (9-10)
			{
				...
				question: 'How do you say "You speak Spanish and English"? (hablar = to speak, español = Spanish, inglés = English)',
				correctAnswer: 'hablas español y ingles',
				correctExplanation: 'Excellent! "Hablas español y inglés" (AH-blahs es-pahn-YOHL ee een-GLAYS) - perfect for conversations!',
				wrongExplanation: 'Remember: use tú form "hablas" + español y inglés',
				alternativeQuestion: 'How do you say "We eat pizza or pasta"? (comer = to eat, pizza = pizza, pasta = pasta)',
				alternativeAnswer: 'comemos pizza o pasta'
			},
			{
				type: 'practice',
				questionNumber: 10,
				inputType: 'application',
				title: 'Real World Application',
				question: 'How do you say "They live in Mexico and work in the city"? (vivir = to live, trabajar = to work, en México = in Mexico, en la ciudad = in the city)',
				correctAnswer: 'viven en mexico y trabajan en la ciudad',
				correctExplanation: 'Perfect! "Viven en México y trabajan en la ciudad" (VEE-vehn ehn MEH-hee-koh ee trah-BAH-hahn ehn lah see-oo-DAHD) - great for talking about people!',
				wrongExplanation: 'Remember: use ellos/ellas form "viven" y "trabajan"',
				alternativeQuestion: 'How do you say "She writes emails or letters"? (escribir = to write, emails = emails, cartas = letters)',
				alternativeAnswer: 'escribe emails o cartas'
			},
			{
				type: 'completion',
					...
					<div class="flex justify-between items-center mt-8">
						<div class="flex items-center space-x-4">
							...
							{#if currentStepData.type === 'practice'}
								...
								{#if currentStep >= 2}
									<span class="text-sm text-green-600 font-medium">You're mastering Spanish! 🎆</span>
								{/if}
							{/if}
						</div>
